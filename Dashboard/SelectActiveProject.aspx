<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectActiveProject.aspx.cs" Inherits="Default2" %>
                                ...
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                       ...
                                       <select class="form-control" id="activeProject" name="activeProject">
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="Select" ForeColor="Black" OnClick="Button1_Click" Font-Bold="True" Font-Size="Medium" />
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                               <%-- <div class="col-lg-6">

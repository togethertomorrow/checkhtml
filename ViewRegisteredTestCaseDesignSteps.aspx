<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewRegisteredTestCaseDesignSteps.aspx.cs" Inherits="Default2" %>
...
<head>
    ...
    <link href="bower_components/datatables-plugins/features/searchHighlight/dataTables.searchHighlight.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="wrapper">
          ...
          <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="page-header" style="font-size:large;color:gray;font-weight:bold" href="index.html">CSS CORP AUTOMATION DASHBOARD</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="SelectActiveProject.html">Switch Active Project</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Select Active Project</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="form-group">
                                            <label>Selects</label>
                                       <select class="form-control" id="activeProject" name="activeProject">

                                        <%
                                            String shopqry = "select * from public.project  ";
                                            String tempStatus = "";
                                            ...
                                            try
                                            {
                                                ...
                                                Hashtable hashProjectDetails = objdb.getProjectDetails();
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="Select" BackColor="#006666" BorderColor="Black" BorderStyle="Solid" ForeColor="White" OnClick="Button1_Click" />
                                         <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">

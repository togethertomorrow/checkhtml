    ...
    <form id="dd"  method="post" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: cadetblue">Test Case Design Steps </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Choose the Test case to work on
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="activetestcase" name="activetestcase">
                                                ...
                                                <%
                                                    ...
                                                    if (Session["ActiveTestcase"] != null)
                                                    {
                                                        
                                                        active_testcase = Session["ActiveTestcase"].ToString();
                                                        Session["ActiveTestcase"] = null;
                                                    }
                                                    try
                                                    {
                                                        ...
                                                        Hashtable hashtestcaseDetails = objdb.gettestcasedetails();
                                                        List<DictionaryEntry> dic = hashtestcaseDetails.Cast<DictionaryEntry>().OrderBy(entry => entry.Value).ToList();
                                                        if (active_testcase != "")
                                                        {
                                                            foreach (var entry in dic)
                                                            {

                                                                if (entry.Key.ToString().ToLower().Equals(active_testcase))
                                                                {
    ...
    try {
        ...
        else
        {
            ...
            if (testCaseID.Trim().Length>0)
            {
                ...
                Query = "select * from testcasedesignsteps where testcaseid = " +testCaseID;
                Query = "   SELECT STEPS.ID,STEPS.stepid,STEPS.obj_ref_id,obj.obj_ref_name,obj.target_property,STEPS.testcaseid, STEPS.htmlelementtype,ACTION.actiontypename,STEPS.status,STEPS.valuetext FROM test_case_design_steps STEPS inner join actiontype ACTION on ACTION.ID=STEPS.actiontype_id  inner join obj_repository obj on STEPS.obj_ref_id =  obj.id where  STEPS.testcaseid = (SELECT ID FROM testcases WHERE id=" + testCaseID + ")ORDER BY STEPS.stepid ASC";
             ...
             //   Response.Write("<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + active_state + "\">");
                ...
                //}
                    ...
                    Response.Write("<td id=\"" +
                                ...
                                "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + loopCount + "</td>");
                    ...
                    Response.Write("<td id=\"" +
                            ...
                            "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + obj_ref_name + "</td>");
                    ...
                    if (action_type.ToUpper().Equals("ExecuteSharedSteps".ToUpper()))
                    {
                        ...
                        Response.Write("<td id=\"" +
                           ...
                           "\" style=\"text-align: left; white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" +
                           "<a style=\"color:blue;white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\" target=\"_blank\" href=\"viewRegisteredTestCaseDesignSteps.aspx?filter_testCaseID=" + executeSharedStepID + "\">" + element_Property + "</a><input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + active_state + "\">  </td>");
                    ...
                    else
                    {
                        Response.Write("<td id=\"" +
                                    "element_id_" + execution_sequence_identifier +
                                    "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;width:400px;overflow:auto;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + element_Property + "<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + active_state + "\"></td>");
                    }
                    Response.Write("<td id=\"" +
                            "element_class_" + execution_sequence_identifier +
                            "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + element_Value + "</td>");

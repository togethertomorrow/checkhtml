<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddobjectRepository.aspx.cs" Inherits="Default2" %>
...
<body>
    ...
    <div id="wrapper">
         ...
         <div id="page-wrapper">
              <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Object Repository</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
      <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           OBJECT REFERANCE NAME CREATION
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="form-group">
                                            <label>Specify Object Referance Name</label>
                                          
                                            <input class="form-control" type="text" name="objrefname" id="objrefname"  />

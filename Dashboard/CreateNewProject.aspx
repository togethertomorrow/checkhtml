<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateNewProject.aspx.cs" Inherits="Default2" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div  class="form-group">
                                         ...
                                         <%--<button type="submit"  class="btn btn-default";onclick="check()">Sbmit Button</button>--%>
                                        &nbsp;<%-- <button type="reset" class="btn btn-default">Reset Button</button>--%><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Create" Font-Bold="True" ForeColor="Black" />

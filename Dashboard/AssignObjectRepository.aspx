<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignObjectRepository.aspx.cs" Inherits="Default2" %>
...
<head>
    ...
    <title>Assign Object Repository</title>
    ...
    <form id="dd"  method="post" runat="server">
        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-support fa-1x"></i>Maintainence</a>
                                <ul class="nav nav-second-level">
                                    <li>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: cadetblue">Assign Object Repository</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-6">
                                    ...
                                    <form role="form">
                                          <div class="form-group">
                                            <label>Object Reference Name</label>
                                               <select class="form-control" id="activetestcase1" name="activetestcase1">
                                          ...
                                          <div class="form-group">
                                            <label>Target Property</label>
                                              <select class="form-control" id="Target1" name="Target1">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestCaseResults.aspx.cs" Inherits="Default2" %>
    ...
    <form id="dd"  method="post" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: cadetblue">Test Case Results </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    ...
    try {
        ...
        else
        {
            ...
            if (testCaseID.Trim().Length>0)
            {
                ...
                Query = "select tr.ID,tc.testcasename,tr.testcaseid,tr.testresult,tr.duration,tr.runnedby,tr.owner,tr.modifieddate from TestCaseResults TR inner join testcases tc on TR.testcaseid = tc.ID where testcaseid =" +testCaseID  +" and tr.active='Yes'";
           ...
           MySql.Data.MySqlClient.MySqlDataReader reader = null;
            ...
            //tr.id,tc.testcasename,tr.testcaseid,tr.testresult,tr.duration,tr.runnedby,tr.owner,tr.modifieddate 
            while (reader.Read())
            {
                ...
                String Durtion = reader["duration"].ToString();

                String RunnedBy = reader["runnedby"].ToString();
             ...
             //   Response.Write("<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + active_state + "\">");
                Response.Write("" +
                               ...
                               "<input type=\"checkbox\" id=\"Obj_ref_Checkboxes" + execution_sequence_identifier +  "\" name=\"Obj_ref_Checkboxes\" value=\"" + execution_sequence_identifier + "\" onclick=\"enableButtons(this);getCurrentSelectedStepID(this.value);\" />" +
                               "</td>");
               
                 Response.Write("<td id=\"" +
                           "TestcaseName" + execution_sequence_identifier +
                           ...
                           "<a style=\"color:blue;white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\" target=\"_blank\" href=\"TestStepResults.aspx?filter_testCaseID=" + ResultID + "\">" + TestcaseName + "</a>  </td>");

                if (Result.ToUpper().Equals("PASSED"))
                {
                    //Response.Write("" +
                    //        "<td style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;font-size:12px;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:0px;color:green;\">" +
                    //        "" + Result +
                    //        "</td>");
                ...
                Response.Write("<td id=\"" +
                                    "element_id_" + execution_sequence_identifier +
                                    "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;width:400px;overflow:auto;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + Durtion + "<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + Durtion + "\"></td>");

                    Response.Write("<td id=\"" +
                                    "element_id_" + execution_sequence_identifier +
                                    "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;width:400px;overflow:auto;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + RunnedBy + "<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + RunnedBy + "\"></td>");
                
                Response.Write("<td id=\"" +
                                    "element_id_" + execution_sequence_identifier +
                                    "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;width:400px;overflow:auto;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + Owner + "<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + Owner + "\"></td>");

                Response.Write("<td id=\"" +
                                    "element_id_" + execution_sequence_identifier +
                                    "\" style=\"white-space: -moz-pre-wrap !important;word-break: break-all;white-space: normal;text-align: left;font-size:12px;width:400px;overflow:auto;font-family: Arial,'Segoe UI Semilight','Open Sans',Verdana,Helvetica,sans-serif;line-height:auto;background-color:inherit;\">" + Modifieddate + "<input type=\"hidden\" id=\"activity_state_" + execution_sequence_identifier + "\" name=\"activity_state_" + execution_sequence_identifier + "\" value=\"" + Modifieddate + "\"></td>");

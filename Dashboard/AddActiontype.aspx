<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddActiontype.aspx.cs" Inherits="Default2" %>
...
<body>
    ...
    <div id="wrapper">
         ...
         <div id="page-wrapper">
              <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Action Type</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
      <div class="row">
                                ...
                                <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <%
                                            ...
                                            String activeproject = Session["activeprojectname"].ToString();
                                            ...
                                            try
                                            {
                                                ...
                                                {
                                                    if (activeproject.Trim().Equals(entry.Key.ToString()))
                                                    {
                                       ...
                                       <div class="form-group">
                                            <label>Specify Action Type Name</label>
                                          
                                            <input class="form-control" type="text" name="actiontype" id="actiontype"  />
                                   ...
                                   <div  class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <select id="Modifiable" name="Modifiable" class="form-control">
                                     ...
                                     <div class="form-group">
                                            <label>Exit if fail</label>
                                            <select id="exit" name="exit" class="form-control">
                                                <option value="TRUE">Yes</option>
                                                 <option value="FALSE">No</option>
                                    ...
                                    <div class="form-group">
                                            <label>Global For All Project</label>

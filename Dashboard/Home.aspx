                            ...
                            <a href="#"><i class="fa fa-tasks fa-1x"></i>Repository</a>
                              <ul class="nav nav-second-level">
                                <li>
                                   ...
                                   <li>
                                    <a href="EditObjectRepository.aspx">Edit object Repository</a>
                                </li>
                                  <li>
                                    <a href="AssignObjectRepository.aspx">Assign object Repository</a>
                                </li>
                            ...
                            <a href="#"><i class="fa fa-tasks fa-1x"></i>TestExecution</a>
                              <ul class="nav nav-second-level">
                                <li>
                                  ...
                                  <li>
                                    <a href="TestCaseResults.aspx">Results</a>
                                </li>
                        ...
                        <div class="panel-body">
                            <ul class="timeline">
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">Actions</h4>
                                            <p><small class="text-muted"><i class="fa fa-clock-o"></i> 11 hours ago </small>
                                            </p>
                                        </div>
                                        <div class="timeline-body">
                                            <p>Dashboard Application is a interface to automate an appliction</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">Do it </h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>Automate a realtime ventures</p>
                                            <p>Automate the known facts</p>
                                        </div>
                                    </div>
                                </li>

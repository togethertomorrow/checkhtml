<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateNewLanguage.aspx.cs" Inherits="Default2" %>
...
<body>
    ...
    <div id="wrapper">
         ...
         <div id="page-wrapper">
              <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">New Language</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
      <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                            <label>Specify Country Code</label>
                                       ...
                                       <%-- <button type="reset" class="btn btn-default">Reset Button</button>--%>
                                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Create" BorderStyle="None" ForeColor="Black" Font-Bold="True" />

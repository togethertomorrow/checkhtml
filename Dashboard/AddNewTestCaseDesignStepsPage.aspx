<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewTestCaseDesignStepsPage.aspx.cs" Inherits="Default2" %>
...
<body>
    ...
    <form id="dd"  method="post" runat="server" >
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: cadetblue">Edit Test Case Design Step </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <%
        ...
        else
        {
            ...
            Response.Redirect("SelectActiveProject.aspx");
                    ...
                    //string StepID = Session["EditStepID"].ToString();
                     ...
                     StepId = Request.QueryString["RequestType"].Trim();
    ...
    <% 
        ...
        String Obj_query = "SELECT * FROM obj_repository WHERE projectid='" + HttpContext.Current.Session["activeProjectName"].ToString().Trim() + "' order by ID asc";
            ...
            foreach (var entry in dic)
	        {
                ...
                if (obj_ref_name.Equals(entry.Value.ToString().Trim()))
                {
    ...
    <% 
        ...
        System.Collections.Hashtable hashProjectDetails2 = objdb.getTargetReferenceNames(tar_query);
	        ...
	        {
                if (targetproperty.Equals(entry2.Value.ToString().Trim()))
                {
